...
if (_v getVariable 'QS_turretL_locked') then {
	_actionIndex = QS_turretActions pushBack (player addAction ['Розблокувати турель (Лiва)',(missionNamespace getVariable 'QS_fnc_turretActions'),[_v,1,0],80,FALSE,FALSE,'','[] call QS_fnc_conditionTurretActionUnlockL']);
...
if (_v getVariable 'QS_turretR_locked') then {
	_actionIndex = QS_turretActions pushBack (player addAction ['Розблокувати турель (Права)',(missionNamespace getVariable 'QS_fnc_turretActions'),[_v,2,0],79,FALSE,FALSE,'','[] call QS_fnc_conditionTurretActionUnlockR']);
	player setUserActionText [(QS_turretActions select _actionIndex),((player actionParams (QS_turretActions select _actionIndex)) select 0),(format ["<t size='3'>%1</t>",((player actionParams (QS_turretActions select _actionIndex)) select 0)])];
};
if (!(_v getVariable 'QS_turretL_locked')) then {
	_actionIndex = QS_turretActions pushBack (player addAction ['Заблокувати турель (Лiва)',(missionNamespace getVariable 'QS_fnc_turretActions'),[_v,1,1],78,FALSE,FALSE,'','[] call QS_fnc_conditionTurretActionLockL']);
	player setUserActionText [(QS_turretActions select _actionIndex),((player actionParams (QS_turretActions select _actionIndex)) select 0),(format ["<t size='3'>%1</t>",((player actionParams (QS_turretActions select _actionIndex)) select 0)])];
};
if (!(_v getVariable 'QS_turretR_locked')) then {
	_actionIndex = QS_turretActions pushBack (player addAction ['Заблокувати турель (Права)',(missionNamespace getVariable 'QS_fnc_turretActions'),[_v,2,1],77,FALSE,FALSE,'','[] call QS_fnc_conditionTurretActionLockR']);
	player setUserActionText [(QS_turretActions select _actionIndex),((player actionParams (QS_turretActions select _actionIndex)) select 0),(format ["<t size='3'>%1</t>",((player actionParams (QS_turretActions select _actionIndex)) select 0)])];
};
_actionIndex = QS_turretActions pushBack (player addAction ['Вiдмiнити дiї з турелями',(missionNamespace getVariable 'QS_fnc_turretActionCancel'),[],76]);
player setUserActionText [(QS_turretActions select _actionIndex),((player actionParams (QS_turretActions select _actionIndex)) select 0),(format ["<t size='3'>%1</t>",((player actionParams (QS_turretActions select _actionIndex)) select 0)])];
