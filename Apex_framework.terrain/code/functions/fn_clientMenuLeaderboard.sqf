...
_list = [
	[0,'<Empty>',''],
	[1,'Перевізник','Дошка пошани транспортувальникiв'],
	[2,'Лікар','Дошка пошани Бойових медикiв'],
	[3,'---','---'],
	[4,'Золотошукач','Дошка пошани збирачiв золотиз хубiв'],
	[5,'Винищувач Веж','Дошка пошани винищувачiв веж'],
	[6,'Мисливець за головами','Дошка пошани захоплювачiв ворогiв']
];
