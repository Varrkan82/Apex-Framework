...
if (_type isEqualTo 'INIT') exitWith {
	...
	_missionMarkerData = [
		['QS_marker_grid_capState',[-1000,-1000,0],'mil_dot','Icon','','ColorOPFOR',[0.5,0.5],0,[-1000,-1000,0],0,'Квадратiв перетворено: 0 / 0'],
		['QS_marker_grid_rspState',[-1000,-1000,0],'mil_dot','Icon','','ColorOPFOR',[0.5,0.5],0,[-1000,-1000,0],0,'Тунелiв знищено: 0 / 0'],
		['QS_marker_grid_civState',[-1000,-1000,0],'mil_dot','Icon','','ColorCIVILIAN',[0.5,0.5],0,[-1000,-1000,0],0,'Без жертв серед цивiльних'],
		...
		['QS_marker_grid_IDAPmkr',[-1000,-1000,0],'mil_dot','Icon','','ColorOrange',[0.5,0.5],0,[-1000,-1000,0],0,'Мiнне поле (UXO Field)'],
		['QS_marker_grid_IDAPcircle',[-1000,-1000,0],'Empty','Ellipse','Border','ColorOrange',[50,50],0,[-1000,-1000,0],0,''],
		['QS_marker_grid_mtrMkr',[-1000,-1000,0],'mil_dot','Icon','','ColorOPFOR',[0.5,0.5],0,[-1000,-1000,0],0,'Мiномет'],
