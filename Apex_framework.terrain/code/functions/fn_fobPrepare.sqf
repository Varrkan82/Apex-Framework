...
if (_type isEqualTo 1) then {
	...
	'QS_marker_module_fob' setMarkerPos (([_2] call (missionNamespace getVariable 'QS_data_fobs')) # 0);
	'QS_marker_module_fob' setMarkerText (format ['%1FOB %2 (Натиснiть щоб дiзнатися статус)',(toString [32,32,32]),(([_2] call (missionNamespace getVariable 'QS_data_fobs')) # 5)]);
