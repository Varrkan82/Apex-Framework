	...
	[(["O_MBT_02_arty_F","O_T_MBT_02_arty_ghex_F"] select (worldName in ['Tanoa','Lingor3','Enoch'])),[4.01807,-1.67236,-0.0691381],353.719,[],true,true,false,{
		...
		(gunner _arty) addEventHandler [
			'FiredMan',
			{
				...
				_firingMessages = [
					"Термiчне сканування показало, що ворог здiйснив пострiли з артилерiї! Пригнутися!",
					"Ворожi снаряди на пiдльотi! До укриттiв негайно!",
					"Снаряди OPFOR наближаються! Шукайте укриття негайно!",
					"Працює артилерiя, хлопцi! На землю!",
					"Заткнiть цю кляту артилерiю; вони гатять прямо зараз! В укриття!",
					"Пострiли! По нам б’є артилерiя, пики в землю!"
				];
